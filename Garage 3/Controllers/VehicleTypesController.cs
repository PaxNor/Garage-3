...
namespace Garage_3.Controllers
{
    public class VehicleTypesController : Controller
    {
        ...
        public VehicleTypesController(Garage_3Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.VehicleType != null ? 
                          ...
                          Problem("Entity set 'Garage_3Context.VehicleType'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Garage_3Context.VehicleType'  is null.");
            }
            var vehicleType = await _context.VehicleType.FindAsync(id);
            if (vehicleType != null)
            {
